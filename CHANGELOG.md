...
* make more reliable [rcooke-warwick]
* rename leviathan options [rcooke-warwick]
* add diagnostic endpoint to relay worker [rcooke-warwick]
* turn off relay before flashing [rcooke-warwick]
* add relay based testbot worker [rcooke-warwick]
