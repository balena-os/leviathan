...
* core: move worker shim to separate module [Joseph Kogut]
* core: rename worker -> workerClient [Joseph Kogut]
* core: create WorkerClient object with address param [Joseph Kogut]
