...
module.exports = {
  ...
  run: async (test, context, options, components) => {
    ...
    await context.balena.sdk.createApplication(applicationNameModem, options.deviceType)

    console.log(`Creating device placeholder on ${applicationNameModem}`)
    const placeholder = await context.balena.sdk.createDevicePlaceholder(applicationNameModem)
    ...
    test.tearDown(async () => {
      await context.balena.sdk.removeApplication(applicationNameModem)
    })
  }
}
