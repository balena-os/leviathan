...
module.exports = {
  ...
  run: async (test, context, options, components) => {
    ...
    test.resolveMatch(components.balena.sdk.getApplicationCommit(applicationNameMoveDevice), hashMoveDevice)
    ...
    test.resolveMatch(components.balena.sdk.getDeviceCommit(context.uuid), hashMoveDevice)
