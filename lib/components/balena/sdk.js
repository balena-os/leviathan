...
module.exports = class BalenaSDK {
  ...
  getLatestRelease(application) {
    return this.balena.models.release.getLatestByApplication(application).get('commit');
  }

  triggerUpdateCheck(device) {
    return this.balena.models.device.update(device);
  }
};
