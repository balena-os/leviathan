...
module.exports = class BalenaSDK {
  ...
  getDeviceEnvVariable (device, key) {
    return this.balena.models.device.envVar.get(device, key)
  }

  setDeviceEnvVariable (device, key, value) {
    return this.balena.models.device.envVar.set(device, key, value)
  }

  removeDeviceEnvVariable (device, key) {
    return this.balena.models.device.envVar.remove(device, key)
  }

  getDeviceConfigVariable (device, key) {
    return this.balena.models.device.configVar.get(device, key)
  }

  setDeviceConfigVariable (device, key, value) {
    return this.balena.models.device.configVar.set(device, key, value)
  }

  removeDeviceConfigVariable (device, key) {
    return this.balena.models.device.configVar.remove(device, key)
  }

  rebootDevice (device) {
    return this.balena.models.device.reboot(device)
  }
  ...
  getApplicationInfo (device) {
    return this.balena.models.device.getApplicationInfo(device)
  }
  ...
  enableLockOverride (device) {
    return this.balena.models.device.enableLockOverride(device)
  }

  disableLockOverride (device) {
    return this.balena.models.device.disableLockOverride(device)
  }
