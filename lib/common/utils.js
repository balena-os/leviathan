...
const self = (module.exports = {
  waitProgressCompletion: async (promise, terminate, _times = 0, _delay = 30000) => {
    if (_times > 20) {
    ...
    if (
      ...
      return self.waitProgressCompletion(promise, terminate, _times + 1);
    }

    return self.waitProgressCompletion(promise, terminate);
  },
