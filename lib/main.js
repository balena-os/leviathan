...
const setup = async () => {
  ...
  console.log('DashboardURL: ', context.dashboardUrl)
...
const main = async () => {
  ...
  _.each([
    ...
    require('../tests/kernel-module-build'),
    require('../tests/reload-supervisor'),
    require('../tests/override-lock'),
    require('../tests/persistent-logging'),
    require('../tests/bluetooth-test'),
    require('../tests/push-full-desktop-container'),
    ...
    require('../tests/preload'),
    require('../tests/hostapp-update-old-to-new'),
    require('../tests/local-mode'),
    require('../tests/self-served-hostOs-update'),
    require('../tests/modem'),
