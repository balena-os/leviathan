...
if (options.interactiveTests) {
  ava.test('experience: Enter running application container', async (test) => {
    ...
    return utils.runManualTestCase(test, {
      prepare: [
        'Ensure the device is running an application. You can clone one of the repos and change directory to it:',
        ...
        `Add resin remote url: "git remote add resin <URL>" (copy the link from the app's dashboard: ${context.dashboardUrl})`,
